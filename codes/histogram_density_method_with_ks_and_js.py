...
class HistogramDensityMethodWithJS(BatchDetector):
    """
    ...
    def update(self, X, y_true=None, y_pred=None):
        ...
        for f in range(self._input_col_dim):
            ...
            self.feature_distances.append(f_distance)
        ...
        if self.total_batches > 1:
            self.feature_epsilons = [
                a_i - b_i
                for a_i, b_i in zip(
                    self.feature_distances, self._prev_feature_distances
                )
            ]
                ...
                if current_epsilon > self.beta:
                    ...
                    if self._input_col_dim > 1:
                        self.feature_info = {
                            ...
                            "Feature_Distances": self.feature_distances,
        ...
        if self._drift_state != "drift":
            ...
            self._prev_feature_distances = self.feature_distances
