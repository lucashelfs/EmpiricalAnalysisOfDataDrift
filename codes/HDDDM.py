from codes.histogram_density_method_with_ks_and_js import (
    HistogramDensityMethodWithJS,
)


class HDDDM(HistogramDensityMethodWithJS):
...
class JSDDM(HistogramDensityMethodWithJS):
    input_type = "batch"
