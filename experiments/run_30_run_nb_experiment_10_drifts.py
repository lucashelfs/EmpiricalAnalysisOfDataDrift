#!/usr/bin/env python3
"""
30-Run Naive Bayes Experiment with 10 Drifts

This script runs a comprehensive 30-run experiment focused on Naive Bayes
with 10 drift points to test drift detection effectiveness under high drift frequency.
"""

from codes.synthetic_multi_run_experiment import SyntheticMultiRunExperiment

def main():
    print("Starting 30-Run Naive Bayes Experiment (10 Drifts)")
    print("=" * 50)
    
    # Configure experiment for 30 runs, NB only, 10 drifts
    experiment = SyntheticMultiRunExperiment(
        ...
        num_drifts=10  # 10 drift points instead of 2
    )
    ...
    print(f"- Number of drifts: 10 (vs 2 in previous experiment)")
