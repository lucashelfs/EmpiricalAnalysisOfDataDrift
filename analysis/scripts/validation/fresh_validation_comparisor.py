#!/usr/bin/env python3
"""
Fresh Validation Comparisor

Modified version of comparisor.py that outputs to a separate directory
for statistical validation comparison.
"""
...
def run_single_experiment(
    ...
    drift_results, test_results, X_shape = run_test(
        dataset=dataset,
        batch_size=batch_size,
        plot_heatmaps=False,  # Disable plots for speed
        algorithm=algorithm,
        drift_alignment_within_batch=drift_alignment_within_batch,
